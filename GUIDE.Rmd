...
On Mac OS, run the `install_mac` shell script to automatically install the
package along with R dependencies.  A symbolic link to the program is created
at `$HOME/Desktop/CHIIMP`.
